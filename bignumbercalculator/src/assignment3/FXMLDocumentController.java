...
public class FXMLDocumentController implements Initializable {
    ...
    // To indicate which operator has been chosen recently
    static short flag = 0;
    ...
    @FXML
    private void handleButtonMultAction(ActionEvent event) {
        operator.setText("x");
        flag = 3;
    }
    @FXML
    ...
    private void handleButtonComputeAction(ActionEvent event) {
        ...
        if(flag >= 1 && flag <= 7 && res != null)
            ...
            result.setText("Please choose an operator !");
    }
    @FXML
